...
import { VersusMatchCard } from "../../../src/components/card/versus_match";
...
describe("VersusMatchCard", () => {
  ...
  test("Correct winner (second)", () => {
    ...
    expect(div1.classList.contains("bg-p-green-200")).toBe(false);
