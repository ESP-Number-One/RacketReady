export function MatchCard(props: { score: Record<string, number> }) {
  ...
  return (
    <div className="bg-gray-400 text-center w-min rounded-lg text-white overflow-hidden">
      <div className="flex justify-between whitespace-nowrap text-xl font-bold items-center">
        <p className="m-2">{firstKey} </p>
        <p
          className="ml-2 p-2"
          style={{
            backgroundColor: firstValue >= secondValue ? "green" : undefined,
          }}
        >
          {firstValue}
        </p>
